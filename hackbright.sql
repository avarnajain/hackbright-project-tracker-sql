...
2	Dictionary	Make key, value pairs	50
3	Class	Organize data into classes	150
\.
...
--
-- Name: github_uidx; Type: INDEX; Schema: public; Owner: engineer
--

CREATE UNIQUE INDEX github_uidx ON public.students USING btree (github);
